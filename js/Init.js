...
function init(){
	...
	"","     The code for this site can be found on my github page, along with my other projects I've worked on in my college years. Links to my social media pages, resume, portfolio, and github profile can be found on the top banner of the page."];
	...
	RubyJacket.foreground.setPrimaryColor({r:25,g:25,b:25});
	RubyJacket.foreground.setSecondaryColor({r:0,g:0,b:0});
